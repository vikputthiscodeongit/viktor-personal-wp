<?php
    ...
    function add_styles_scripts() {
        $style_version = date("His_dmY", filemtime(plugin_dir_path( __FILE__ ) . "/dist/css/style.css"));
        $bundle_version  = date("His_dmY", filemtime(plugin_dir_path( __FILE__ ) . "/dist/js/bundle-main.js"));

        wp_enqueue_style("fonts", "https://fonts.googleapis.com/css2?family=Fira+Code:wght@400;600&family=Miriam+Libre:wght@400;700&family=Roboto&display=swap", false, null);
